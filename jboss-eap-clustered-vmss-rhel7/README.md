...
<a href="https://github.com/SpektraSystems/redhat-mw-cloud-quickstart/blob/master/jboss-eap-rhel7-vmss/azuredeploy.json" target="_blank"> [Red Hat - JBoss EAP 7.2 on RHEL 7.7 VMSS (clustered)]</a> - Template for Red Hat - JBoss EAP 7.2 on RHEL 7.7 VMSS (clustered, multi-VM)