...
1. Azure Subscription with specified payment method (RHEL 7.7 is a market place product and requires payment method to be specified in Azure Subscription)
