# Red Hat - JBoss EAP 7.2 on RHEL 8.0 VM (clustered, multi-VM)
...
This template creates all the Azure compute resources to run JBoss EAP 7.2 cluster on top of 2 RHEL 8.0 VMs which are added to the backend pool of a Load Balancer. The following resources are created by this template:
...
Build your environment with JBoss EAP 7.2 cluster on top of 2 RHEL 8.0 VMs which is added to the backend pool of the Load Balancer on Azure in a few simple steps:  
